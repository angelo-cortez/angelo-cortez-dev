    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          ...
          <br />
          <br />
          After three years at Epic, I joined 8x8 where I’ve built UCaaS and CCaaS automations for SMBs and enterprises, creating integrations that streamline operations and drive efficiency for customers' contact centers. I also collaborate with customers on custom routing configurations to enhance call flow, automate interactions, and improve customer experience.
          <br />
          <br />
